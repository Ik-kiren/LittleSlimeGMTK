...
idleState = function(){
	if(pointToGo.getNewPoint){
		do {
			pointToGo.x1 = irandom_range(x - 50, x + 50);
			pointToGo.y1 = irandom_range(y - 50, y + 50);
		} until ((pointToGo.x1 > 5  && pointToGo.x1 < room_width - 5) && (pointToGo.y1 > 5 && pointToGo.y1 < room_height - 5));
